          ...
          <div class="row g-4">
            <div class="col-md-7 col-lg-8">
              <x-form class="needs-validation" method="POST" action="{{ route('user.about_me.update', [$user, 'profile' => $userProfile]) }}" enctype="multipart/form-data">
                @method('PUT')
                <div class="row g-3">
                  <img src="{{ Storage::url($userProfile->avatar) }}" class="rounded-circle" style="width: 200px; height:200px"  alt="Avatar" />
                  <div class="col-9 g-3">
                    <div class="col-12">
                      <label for="firstName" class="form-label">Имя</label>
                      <input name="firstName" type="text" class="form-control" id="firstName" value="{{ $userProfile->name }}">
                    </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      <input name="nickname" type="text" class="form-control" id="nickname" value="{{ $user->name }}">
                    </div>
                  </div>
