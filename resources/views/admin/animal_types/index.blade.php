            ...
            <tr id="row-{{ $animal_type->id }}">
                ...
                <td>
                    <div class="d-flex">
                        ...
                        <x-button color="outline-danger" class="showDeleteModal" data-action="{{ route('admin.animal_types.destroy', $animal_type) }}" data-remove="#row-{{ $animal_type->id }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
